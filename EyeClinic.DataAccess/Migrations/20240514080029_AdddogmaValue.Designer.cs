...
namespace EyeClinic.DataAccess.Migrations
{
    ...
    [Migration("20240514080029_AdddogmaValue")]
    partial class AdddogmaValue
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EyeClinic.DataAccess.Entities.MarketsEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("MarketsProductsId")
                        .HasColumnType("int");

                    b.Property<double>("Quinttity")
                        .HasColumnType("float");
                    ...
                    b.HasIndex("MarketsProductsId");

                    b.ToTable("MarketsEntries");
                });

            modelBuilder.Entity("EyeClinic.DataAccess.Entities.MarketsExtry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("MarketsExtries");
                });

            modelBuilder.Entity("EyeClinic.DataAccess.Entities.MarketsProducts", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<double>("Extry")
                        .HasColumnType("float");

                    b.Property<double>("FirstTermValue")
                        .HasColumnType("float");

                    b.Property<DateTime?>("LastModifiedDate")
                        .HasColumnType("datetime2");

                    b.Property<string>("MarketsProductName")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<double>("TheMinimumValue")
                        .HasColumnType("float");

                    b.HasKey("Id");

                    b.ToTable("MarketsProducts");
                });
            ...
            modelBuilder.Entity("EyeClinic.DataAccess.Entities.OrderQueue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EyeClinic.DataAccess.Entities.PatientVisitsTest", b =>
                {
                    ...
                    b.Property<int?>("WareHouseReadyMaterialId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("WareHouseReadyMaterialId");
            ...
            modelBuilder.Entity("EyeClinic.DataAccess.Entities.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EyeClinic.DataAccess.Entities.ProductDepartment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EyeClinic.DataAccess.Entities.ProductDescription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("DescriptionProductDepartmentId")
                        .HasColumnType("int");

                    b.Property<DateTime?>("LastModifiedDate")
                        .HasColumnType("datetime2");

                    b.Property<int>("ProductDescriptionDepartmentId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("DescriptionProductDepartmentId");
            ...
            modelBuilder.Entity("EyeClinic.DataAccess.Entities.PublicCustomerOrderProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("PublicCustomerOrderProduct");
                });
            ...
            modelBuilder.Entity("EyeClinic.DataAccess.Entities.ReadyProduct", b =>
                {
                    ...
                    b.Property<double>("IsIncreaseDogmaValue")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("EyeClinic.DataAccess.Entities.ReadyProductOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("ReadyProductedId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ReadyProductedId");

                    b.ToTable("ReadyProductOrder");
                });

            modelBuilder.Entity("EyeClinic.DataAccess.Entities.ReadyProducted", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EyeClinic.DataAccess.Entities.Test", b =>
                {
                    ...
                    b.Property<double>("FirstTermBalanceWareHouseValue")
                        .HasColumnType("float");
                    ...
                    b.Property<double>("TotalEntryWareHouseValue")
                        .HasColumnType("float");

                    b.Property<double>("TotalResult")
                        .HasColumnType("float");

                    b.Property<double>("TotalWareHouseValue")
                        .HasColumnType("float");

                    b.Property<double>("TotalWasteWareHouseValue")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("EyeClinic.DataAccess.Entities.WareHouseReadyMaterial", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("WareHouseReadyMaterials");
                });
            ...
            modelBuilder.Entity("EyeClinic.DataAccess.Entities.MarketsEntry", b =>
                {
                    b.HasOne("EyeClinic.DataAccess.Entities.MarketsProducts", null)
                        .WithMany("MarketsEntries")
                        .HasForeignKey("MarketsProductsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("EyeClinic.DataAccess.Entities.PatientVisitsTest", b =>
                {
                    ...
                    b.HasOne("EyeClinic.DataAccess.Entities.WareHouseReadyMaterial", null)
                        .WithMany("PatientVisitsTests")
                        .HasForeignKey("WareHouseReadyMaterialId");
            ...
            modelBuilder.Entity("EyeClinic.DataAccess.Entities.Product", b =>
                {
                    b.HasOne("EyeClinic.DataAccess.Entities.ProductDepartment", "ProductDepartment")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("EyeClinic.DataAccess.Entities.ProductDescription", b =>
                {
                    b.HasOne("EyeClinic.DataAccess.Entities.ProductDepartment", "DescriptionProductDepartment")
                        .WithMany("ProductDescriptions")
                        .HasForeignKey("DescriptionProductDepartmentId");

                    b.Navigation("DescriptionProductDepartment");
                });
            ...
            modelBuilder.Entity("EyeClinic.DataAccess.Entities.PublicCustomerOrderProduct", b =>
                {
                    b.HasOne("EyeClinic.DataAccess.Entities.ProductDescription", "ProductDescription")
                        .WithMany("PublicCustomerOrderProducts")
                        .HasForeignKey("ProductDescriptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EyeClinic.DataAccess.Entities.Product", "Product")
                        .WithMany("PublicCustomerOrderProducts")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EyeClinic.DataAccess.Entities.PublicCustomerOrder", "PublicCustomerOrder")
                        .WithMany("PublicCustomerOrderProducts")
                    ...
                    b.Navigation("PublicCustomerOrder");
                });
            ...
            modelBuilder.Entity("EyeClinic.DataAccess.Entities.ReadyProductOrder", b =>
                {
                    b.HasOne("EyeClinic.DataAccess.Entities.ProductDescription", "GetProductDescription")
                        .WithMany("ReadyProductOrders")
                        .HasForeignKey("ProductDescriptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("EyeClinic.DataAccess.Entities.ReadyProducted", "ReadyProducted")
                        .WithMany("ReadyProductOrders")
                        .HasForeignKey("ReadyProductedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("GetProductDescription");

                    b.Navigation("Product");

                    b.Navigation("ReadyProducted");
                });
            ...
            modelBuilder.Entity("EyeClinic.DataAccess.Entities.MarketsProducts", b =>
                {
                    b.Navigation("MarketsEntries");

                    b.Navigation("MarketsExtries");
                });
            ...
            modelBuilder.Entity("EyeClinic.DataAccess.Entities.Product", b =>
                {
                    b.Navigation("PublicCustomerOrderProducts");

                    b.Navigation("ReadyProductOrders");
                });
