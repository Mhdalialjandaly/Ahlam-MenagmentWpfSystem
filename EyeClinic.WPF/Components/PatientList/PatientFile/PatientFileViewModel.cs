...
using EyeClinic.WPF.Components.PatientList.PatientFile.EyeDiagnosis;
using EyeClinic.WPF.Components.PatientList.PatientFile.EyeTests;
using EyeClinic.WPF.Components.PatientList.PatientFile.FinishVisit;
using EyeClinic.WPF.Components.PatientList.PatientFile.LabTests;
...
namespace EyeClinic.WPF.Components.PatientList.PatientFile
{
    public partial class PatientFileViewModel
    {
    ...
    public partial class PatientFileViewModel : BaseViewModel<PatientFileView>
    {
        ...
        public PatientFileViewModel(IUnityContainer container, IPatientRepository patientRepository,
        ...
        public async Task Initialize(int patientId, int patientVisitId, bool isPopup = false) {
            PatientVisitId = patientVisitId;

            var patientVisitViewModel = _container.Resolve<PatientVisitListViewModel>();
            await patientVisitViewModel.Initialize(patientId);
            patientVisitViewModel.PatientVisitChanged += OnPatientVisitChanged;
